...
- (void)customMainView {
    self.backgroundColor = KColorRGBA(0, 0, 0, 0.75);
    ...
    UILabel *titleLbl = [LSKViewFactory initializeLableWithText:@"温馨提示" font:16 textColor:KColorHexadecimal(0x666666, 1.0)  textAlignment:1 backgroundColor:nil];
    ...
    UILabel *titleLbl1 = [LSKViewFactory initializeLableWithText:_title font:20 textColor:KColorHexadecimal(kAPP_Main_Color, 1.0) textAlignment:0 backgroundColor:nil];
    ...
    textView.textColor = KColorHexadecimal(0X666666, 1.0);
    ...
    UIButton *leftBtn = [LSKViewFactory initializeButtonWithTitle:leftString nornalImage:nil selectedImage:nil target:self action:@selector(btnClick:) textfont:15 textColor:KColorHexadecimal(0x666666, 1.0) backgroundColor:nil backgroundImage:nil];
    leftBtn.tag = 201;
    ...
    UIButton *rightBtn = [LSKViewFactory initializeButtonWithTitle:rightString nornalImage:nil selectedImage:nil target:self action:@selector(btnClick:) textfont:15 textColor:KColorHexadecimal(0x666666, 1.0) backgroundColor:nil backgroundImage:nil];
    rightBtn.tag = 202;
