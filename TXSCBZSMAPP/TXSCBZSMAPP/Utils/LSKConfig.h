...
static NSString * const kTabBarTitleNornal_Color = kNavigationBarButtonTitle_Color;
static NSString * const kTabBarTitleSelected_Color = @"1e9dff";
static const NSInteger kTabBarTitle_Font = 10;
//主要的背景色
static const NSInteger kMainBackground_Color  = 0xdadbdb;
//线的颜色
