...
- (void)_layoutMainView {
    ...
    UILabel *presentLbl = [LSKViewFactory initializeLableWithText:nil font:50 textColor:KColorHexadecimal(kNavi_Yellow_Color, 1.0) textAlignment:1 backgroundColor:nil];
    ...
    [_xingzuoNameLbl mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(presentLbl.mas_bottom).with.offset(11);
        make.centerX.equalTo(ws);
    }];
