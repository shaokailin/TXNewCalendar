...
- (void)setupCellContent:(NSString *)content {
    ...
    CGFloat contentHeight = height + _circleHeight - 10;
...
- (void)setupContent:(NSDictionary *)dict {
    [self.progressView setupScore:dict];
...
- (void)_layoutMainView {
    _circleHeight = WIDTH_RACE_6S(250);
    TXSMFortuneProgressView *pressView = [[TXSMFortuneProgressView alloc]initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, _circleHeight) progressType:ProgressType_Today];
    ...
    messageView.frame = CGRectMake(0, _circleHeight - 10, SCREEN_WIDTH, 0);
