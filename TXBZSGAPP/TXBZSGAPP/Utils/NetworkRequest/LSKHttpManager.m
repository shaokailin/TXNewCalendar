...
static NSString * const kHttpLoadingToken = @"oo19zHOO9yDcpkBMnBVAAN1ZLMiG85we";
    ...
    if (entity) {
        switch (entity.requestType) {
            ...
            case 2:
            {
                ...
                identifier =  [[LSKHttpManager sharedInstance]_uploadImageReuqestWithApiPath:mediaEntity.requestApi params:mediaEntity.params name:mediaEntity.name type:mediaEntity.uploadType medias:mediaEntity.mediaArray success:success failure:failure];
                break;
            }
            case 1:
            default:
                identifier =  [[LSKHttpManager sharedInstance]_postReuqestWithApiPath:entity.requestApi params:entity.params success:success failure:failure];
                break;
        }
    }
    return identifier;
