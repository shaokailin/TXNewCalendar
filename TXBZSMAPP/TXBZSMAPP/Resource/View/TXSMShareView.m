...
- (void)showInView {
    ...
    if (!isShow) {
        ...
        [UIView animateWithDuration:0.25 animations:^{
            ...
            self->_contentView.frame = CGRectMake(0, SCREEN_HEIGHT - kContentViewHeight - self->_tabbarHeight , SCREEN_WIDTH, kContentViewHeight);
        }];
    }
}
...
- (void)cancleSelectedClick {
    ...
    [UIView animateWithDuration:0.25 animations:^{
        ...
        self->_contentView.frame = CGRectMake(0, CGRectGetHeight(self.frame), SCREEN_WIDTH, kContentViewHeight);
