...
//    if ([requestUrl containsString:@"alipay://"] && [[UIApplication sharedApplication]canOpenURL:[NSURL URLWithString:requestUrl]]) {
//        [[UIApplication sharedApplication]openURL:[NSURL URLWithString:requestUrl]];
//        return NO;
//    }else
        if ([requestUrl containsString:@"weixin://"] && [[UIApplication sharedApplication]canOpenURL:[NSURL URLWithString:requestUrl]]) {
        [[UIApplication sharedApplication]openURL:[NSURL URLWithString:requestUrl]];
        return NO;
    }
    return YES;
