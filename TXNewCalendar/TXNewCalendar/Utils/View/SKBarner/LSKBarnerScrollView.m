...
- (UIPageControl *)pageControl {
    if (!_pageControl) {
        ...
        _pageControl.pageIndicatorTintColor = KColorHexadecimal(kBannerDotNornal_Color, 1.0);
        _pageControl.currentPageIndicatorTintColor= KColorHexadecimal(kBannerDotSelect_Color,    1.0);
